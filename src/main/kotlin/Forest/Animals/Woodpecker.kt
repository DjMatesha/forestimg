...
class Woodpecker(
    ...
    override var img = Circle(10.0, Color.CADETBLUE)
    ...
    override val foodPart = ETreePart.TRUNK
    ...
    override fun copy(count: Int): Woodpecker {
        val temp = Woodpecker(row, col, count, testMode)
